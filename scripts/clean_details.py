...
data = [
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"Magnetic Therapy Products",
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"The Gruffalo by Julia Donaldson",
         ...
         {
            "name":"Bad Blood: Secrets and Lies in a Silicon Valley Startup by John Carreyrou",
         ...
         {
            "name":"Where the Wild Things Are by Maurice Sendak",
            "category":"Children's Books",
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"Rare Science Fiction Books",
            "category":"Rare Books",
   ...
   },
   {
      ...
      "products":[
         {
            "name":"Dapper Dan Hair Styling Cream",
         ...
         {
            "name":"Baxter of California Pomade",
            "category":"Men's Grooming",
         ...
         {
            "name":"TRESemmé Shampoo and Conditioner",
            "category":"Haircare",
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"Joint Supplements for Pets",
         ...
         {
            "name":"Fish Tank Cleaning Supplies",
            "category":"Fish & Aquarium",
         ...
         {
            "name":"Cat Health and Wellness Products",
            "category":"Cat Supplies",
         ...
         {
            "name":"Pet Pain Relief Medications",
            "category":"Pet Health & Wellness",
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"Japanese Ramen Ingredients",
         ...
         {
            "name":"Chinese Cuisine Ingredients",
            "category":"International Foods",
         ...
         {
            "name":"Middle Eastern Cuisine Ingredients",
            "category":"International Foods",
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"TP-Link Archer C4000 Router",
            "category":"Networking & Wireless",
   ...
   },
   {
      ...
      "products":[
         ...
         {
            "name":"Dog Health and Wellness Products",
            "category":"Dog Supplies",
         ...
         {
            "name":"Pet Vitamins and Supplements",
            "category":"Pet Health & Wellness",
